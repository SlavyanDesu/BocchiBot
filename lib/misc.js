 ...
 */
const email = (emailTarget, subjekEmail, pesanEmail) => new Promise((resolve, reject) => {
    console.log(`Sending email to: ${emailTarget}\nSubjek: ${subjekEmail}\nPesan: ${pesanEmail}...`)
    fetchJson(`https://videfikri.com/api/spamemail?email=${emailTarget}&subjek=${subjekEmail}&pesan=${pesanEmail}`)
