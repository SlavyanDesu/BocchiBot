...
const anitokil = () => new Promise((resolve, reject) => {
                console.log('Searching for Anitoki latest update...')
                fetchJson(`https://melodicxt.herokuapp.com/api/anitoki?apiKey=YourApikey`)
                    .then((result) => resolve(result))
                    .catch((err) => reject(err))
            })
